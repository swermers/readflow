    ...
    <div className="p-6 md:p-12 min-h-screen">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:gap-5 lg:grid-cols-3 stagger-children">
        {dedupedEmails.map((email: any) => (
          <article key={email.id} className="relative flex h-52 md:h-56 flex-col justify-between overflow-hidden rounded-2xl border border-line bg-surface p-4 md:p-5 shadow-[0_8px_24px_rgba(15,23,42,0.04)] transition-all duration-200 hover:-translate-y-0.5 hover:border-accent/50 hover:shadow-[0_14px_32px_rgba(15,23,42,0.12)]">
            <div>
