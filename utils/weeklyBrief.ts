...
export async function generateWeeklyBriefForUser(supabase: SupabaseClient, userId: string, autoGenerated: boolean) {
  const { weekStartDate, weekEndDate } = getLastCompletedWeekRange();
